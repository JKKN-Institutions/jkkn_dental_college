    ...
    <section className="py-16 md:py-24 px-4 bg-gray-50">
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 md:gap-16">
          {/* Left - Eligibility */}
          <div>
            <h3 className="text-[#FF6B35] text-sm md:text-base font-bold uppercase tracking-wider mb-4">Admissions 2025-26</h3>
            <h2 className="text-3xl md:text-4xl font-bold text-[#0A4D5C] mb-8">
            ...
            <div className="bg-blue-50 rounded-2xl p-6 mb-6">
              <h4 className="text-xl font-bold text-[#0A4D5C] mb-4">BDS Eligibility</h4>
            ...
            <div className="bg-blue-50 rounded-2xl p-6 mb-8">
              <h4 className="text-xl font-bold text-[#0A4D5C] mb-4">MDS Eligibility</h4>
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  <div className="text-[#4CAF50] text-xl flex-shrink-0">✓</div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                href="/admissions"
                className="bg-[#FF6B35] hover:bg-[#FF5722] text-white font-bold py-3 px-8 rounded-full transition-all duration-300 text-center inline-flex items-center justify-center gap-2"
              >
                <span>📞</span>
              ...
              <Link
                href="/contact"
                className="border-2 border-[#0A4D5C] hover:bg-[#0A4D5C] hover:text-white text-[#0A4D5C] font-bold py-3 px-8 rounded-full transition-all duration-300 text-center inline-flex items-center justify-center gap-2"
              >
                <span>✉️</span>
                <span>Email Us</span>
              </Link>
          ...
          <div>
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              <h3 className="text-2xl font-bold text-[#0A4D5C] mb-8">Admission Process</h3>
              ...
              <div className="space-y-6">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="text-lg font-bold text-[#0A4D5C] mb-1">Check Eligibility</h4>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="text-lg font-bold text-[#0A4D5C] mb-1">Register for Counseling</h4>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="text-lg font-bold text-[#0A4D5C] mb-1">Participate in Counseling</h4>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="text-lg font-bold text-[#0A4D5C] mb-1">Document Verification</h4>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="text-lg font-bold text-[#0A4D5C] mb-1">Fee Payment & Enrollment</h4>
