    ...
    <footer className="bg-primary text-white">
      <div className="container-custom py-10 sm:py-12 lg:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
          ...
          <div>
            <h3 className="text-lg sm:text-xl font-bold mb-4 uppercase border-b-2 border-white pb-2 inline-block">
              OUR INSTITUTIONS
            </h3>
            <ul className="space-y-2 text-sm sm:text-base mt-4">
          ...
          <div>
            ...
            <div className="text-sm sm:text-base space-y-3 mt-4">
              <p><strong>Call:</strong> {siteContent.footer.contact.phone}</p>
              <p><strong>Email:</strong> {siteContent.footer.contact.email}</p>
            ...
            <div className="mt-6">
              <h4 className="text-base sm:text-lg font-bold mb-3 uppercase">
                FOLLOW US
              </h4>
