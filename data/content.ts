    ...
    topMenuItems: [
      ...
      },
      {
        ...
        submenu: [
          ...
          { label: "SLOW & ADVANCED LEARNERS", href: "/academics/slow-advanced-learners" },
          {
            label: "COURSES",
  ...
  footer: {
    ...
    institutions: {
      ...
      links: [
        ...
        { name: "JKKN College of Allied Health Sciences", url: "#" },
        { name: "JKKN College of Pharmacy", url: "#" },
        { name: "Karpagam Educational Institutions Institute of Nursing and Para Medical Sciences", url: "#" },
        { name: "JKKN College of Education", url: "#" },
        { name: "JKKN College of Arts and Science (Autonomous)", url: "#" },
        { name: "JKKN College of Engineering and Technology", url: "#" },
        { name: "JKKN Matriculation Higher Secondary School", url: "#" },
        { name: "Kasthuri Vidhyalaya", url: "#" },
      ],
    },
    contact: {
      title: "CONTACT US",
      phone: "Call: +91 94435 53551",
