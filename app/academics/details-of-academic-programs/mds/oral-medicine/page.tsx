  ...
  return (
    <main>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
                ...
                <span className="text-[#FF6B35]">Radiology</span>
              </h1>
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            {/* Left Content */}
            <div>
              <div className="text-[#FF6B35] uppercase font-bold text-sm mb-4 tracking-wider">Program Overview</div>
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-[#FF6B35] to-[#e55a2b] rounded-3xl p-16 h-full flex items-center justify-center">
                <h2 className="text-6xl md:text-7xl font-bold text-white text-center">Diagnostic Center</h2>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <div className="text-[#FF6B35] uppercase font-bold text-sm mb-4 tracking-wider">Course Structure</div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200">
              ...
              <div className="p-8 space-y-4">
                <div className="flex items-start gap-3">
                  <svg className="w-5 h-5 text-[#FF6B35] flex-shrink-0 mt-1" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200">
              <div className="bg-gradient-to-br from-[#01BAEF] to-[#0199c7] p-8 text-center">
                <div className="inline-block bg-white/20 backdrop-blur-sm rounded-full px-4 py-2 mb-4">
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <div className="text-[#FF6B35] uppercase font-bold text-sm mb-4 tracking-wider">What You'll Achieve</div>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <div className="text-[#FF6B35] uppercase font-bold text-sm mb-4 tracking-wider">Admission Requirements</div>
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-200">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="flex items-center gap-3">
                  <svg className="w-6 h-6 text-[#01BAEF] flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <div className="text-[#FF6B35] uppercase font-bold text-sm mb-4 tracking-wider">World-Class Infrastructure</div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* CBCT Unit */}
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200">
              <div className="bg-gradient-to-br from-[#0B4F6C] to-[#0a3f54] p-12 flex items-center justify-center h-64">
            ...
            {/* Digital X-Ray */}
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200">
              <div className="bg-gradient-to-br from-[#FF6B35] to-[#e55a2b] p-12 flex items-center justify-center h-64">
            ...
            {/* Diagnostic Lab */}
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200">
              <div className="bg-gradient-to-br from-[#01BAEF] to-[#0199c7] p-12 flex items-center justify-center h-64">
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <div className="text-[#FF6B35] uppercase font-bold text-sm mb-4 tracking-wider">Campus Life</div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {/* Campus */}
            <div className="bg-gradient-to-br from-[#0B4F6C] to-[#0a3f54] rounded-2xl p-12 flex items-center justify-center h-64 cursor-pointer hover:shadow-xl transition-shadow duration-300">
              <h3 className="text-4xl font-bold text-white text-center">Campus</h3>
            </div>

            {/* Radiology */}
            <div className="bg-gradient-to-br from-[#FF6B35] to-[#e55a2b] rounded-2xl p-12 flex items-center justify-center h-64 cursor-pointer hover:shadow-xl transition-shadow duration-300">
              <h3 className="text-4xl font-bold text-white text-center">Radiology</h3>
            </div>

            {/* Library */}
            <div className="bg-gradient-to-br from-[#01BAEF] to-[#0199c7] rounded-2xl p-12 flex items-center justify-center h-64 cursor-pointer hover:shadow-xl transition-shadow duration-300">
      ...
      <section className="py-16 px-4 bg-gradient-to-br from-[#0B4F6C] to-[#0a3f54]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <div className="text-[#FF6B35] uppercase font-bold text-sm mb-4 tracking-wider">Your Future</div>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <div className="text-[#FF6B35] uppercase font-bold text-sm mb-4 tracking-wider">Investment in Your Future</div>
          ...
          <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200">
            {/* Table Header */}
            <div className="bg-gradient-to-r from-[#0B4F6C] to-[#0a3f54] grid grid-cols-4 gap-4 p-6 text-white font-bold">
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <div className="text-[#FF6B35] uppercase font-bold text-sm mb-4 tracking-wider">Have Questions?</div>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <div className="text-[#FF6B35] uppercase font-bold text-sm mb-4 tracking-wider">Recognition</div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div className="flex flex-col items-center">
              <div className="bg-gradient-to-br from-[#0B4F6C] to-[#0a3f54] rounded-xl p-8 mb-4 w-32 h-32 flex items-center justify-center">
            ...
            {/* NAAC */}
            <div className="flex flex-col items-center">
              <div className="bg-gradient-to-br from-[#FF6B35] to-[#e55a2b] rounded-xl p-8 mb-4 w-32 h-32 flex items-center justify-center">
            ...
            {/* MGR */}
            <div className="flex flex-col items-center">
              <div className="bg-gradient-to-br from-[#01BAEF] to-[#0199c7] rounded-xl p-8 mb-4 w-32 h-32 flex items-center justify-center">
