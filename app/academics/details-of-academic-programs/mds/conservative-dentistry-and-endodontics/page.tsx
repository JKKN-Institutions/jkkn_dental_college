    ...
    <main>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
                MDS Conservative Dentistry & <span className="text-[#FF6B35]">Endodontics</span>
              </h1>
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="flex items-center gap-3">
                  <svg className="w-6 h-6 text-[#FF6B35] flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
            ...
            <div className="bg-[#FF6B35] rounded-2xl p-12 h-full flex items-center justify-center min-h-[400px]">
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-white border border-gray-200 rounded-2xl overflow-hidden hover:shadow-2xl transition-shadow duration-300">
              <div className="bg-gradient-to-br from-[#01BAEF] to-[#0195c4] p-8 text-center">
                <div className="inline-block bg-white/20 backdrop-blur-sm rounded-full px-4 py-2 mb-4">
            ...
            <div className="bg-gray-50 rounded-2xl p-8">
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  <div className="bg-[#FF6B35] text-white w-10 h-10 rounded-full flex items-center justify-center font-bold flex-shrink-0">1</div>
                  <p className="text-gray-700 pt-1">BDS degree from a DCI-recognized dental college</p>
                </div>

                <div className="flex gap-4">
                  <div className="bg-[#FF6B35] text-white w-10 h-10 rounded-full flex items-center justify-center font-bold flex-shrink-0">2</div>
                  <p className="text-gray-700 pt-1">Completion of 1-year compulsory rotating internship</p>
                </div>

                <div className="flex gap-4">
                  <div className="bg-[#FF6B35] text-white w-10 h-10 rounded-full flex items-center justify-center font-bold flex-shrink-0">3</div>
                  <p className="text-gray-700 pt-1">Valid registration with State Dental Council or DCI</p>
                </div>

                <div className="flex gap-4">
                  <div className="bg-[#FF6B35] text-white w-10 h-10 rounded-full flex items-center justify-center font-bold flex-shrink-0">4</div>
                  <p className="text-gray-700 pt-1">Qualified NEET MDS entrance examination</p>
                </div>

                <div className="flex gap-4">
                  <div className="bg-[#FF6B35] text-white w-10 h-10 rounded-full flex items-center justify-center font-bold flex-shrink-0">5</div>
            ...
            <div className="bg-gray-50 rounded-2xl p-8">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="flex items-center gap-3 bg-white rounded-lg p-4 border border-gray-200">
                  <svg className="w-5 h-5 text-[#01BAEF] flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M4 4a2 2 0 012-2h4.586A2 2 0 0112 2.586L15.414 6A2 2 0 0116 7.414V16a2 2 0 01-2 2H6a2 2 0 01-2-2V4z" clipRule="evenodd" />
                  </svg>
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {/* Rotary Systems */}
            <div className="bg-white rounded-2xl overflow-hidden hover:shadow-2xl transition-shadow duration-300">
              <div className="bg-gradient-to-br from-[#01BAEF] to-[#0195c4] p-12 flex items-center justify-center h-48">
            ...
            <div className="bg-white rounded-2xl overflow-hidden hover:shadow-2xl transition-shadow duration-300">
              <div className="bg-gradient-to-br from-[#01BAEF] to-[#0195c4] p-12 flex items-center justify-center h-48">
                <h3 className="text-4xl font-bold text-white text-center">Research Lab</h3>
              </div>
              <div className="p-6">
                <h4 className="font-bold text-gray-800 text-xl mb-3">Research Laboratory</h4>
                <p className="text-gray-600">
                  Well-equipped laboratory for materials research, cell culture, and thesis work.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {/* Campus */}
            <div className="bg-gradient-to-br from-[#0B4F6C] to-[#0a3f54] rounded-2xl p-12 flex items-center justify-center aspect-square hover:shadow-2xl transition-shadow duration-300 cursor-pointer">
              <h3 className="text-3xl md:text-4xl font-bold text-white">Campus</h3>
            </div>

            {/* Clinic */}
            <div className="bg-gradient-to-br from-[#FF6B35] to-[#e55a2b] rounded-2xl p-12 flex items-center justify-center aspect-square hover:shadow-2xl transition-shadow duration-300 cursor-pointer">
              <h3 className="text-3xl md:text-4xl font-bold text-white">Clinic</h3>
            </div>

            {/* Library */}
            <div className="bg-gradient-to-br from-[#01BAEF] to-[#0195c4] rounded-2xl p-12 flex items-center justify-center aspect-square hover:shadow-2xl transition-shadow duration-300 cursor-pointer">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex justify-center mb-6">
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-6 py-2">
              <span className="text-[#FF6B35] font-semibold text-sm uppercase">Your Future</span>
            </div>
          </div>
          ...
          <p className="text-gray-200 text-center mb-12 max-w-4xl mx-auto leading-relaxed">
            An MDS in Endodontics opens diverse career pathways in clinical practice, academia, and research.
          </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-8 hover:bg-white/20 transition-all duration-300">
              <div className="bg-[#FF6B35] w-16 h-16 rounded-2xl flex items-center justify-center mb-6">
                <svg className="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 20 20">
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden">
            {/* Table Header */}
            <div className="grid grid-cols-4 bg-gradient-to-br from-[#0B4F6C] to-[#0a3f54]">
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-gray-600 text-center mb-12">
            Find answers to common queries about the MDS Endodontics program.
          </p>
          ...
          <div className="space-y-4">
            ...
            <details className="group border-2 border-gray-200 rounded-xl overflow-hidden bg-white">
              <summary className="flex items-center justify-between cursor-pointer p-6 font-bold text-gray-800 text-lg hover:bg-gray-50 transition-colors duration-300">
                What is the duration of the MDS Endodontics program?
            ...
            <details className="group border-2 border-gray-200 rounded-xl overflow-hidden bg-white">
              <summary className="flex items-center justify-between cursor-pointer p-6 font-bold text-gray-800 text-lg hover:bg-gray-50 transition-colors duration-300">
                What are the career prospects after completing MDS Endodontics?
                <svg className="w-5 h-5 text-[#FF6B35] transition-transform duration-300 group-open:rotate-180" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clipRule="evenodd" />
                </svg>
              </summary>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-5xl mx-auto">
            {/* DCI */}
            <div className="bg-white rounded-2xl p-8 border border-gray-200 hover:shadow-2xl transition-shadow duration-300">
              <div className="bg-[#0B4F6C] w-20 h-20 rounded-2xl flex items-center justify-center mx-auto mb-6">
            ...
            {/* NAAC */}
            <div className="bg-white rounded-2xl p-8 border border-gray-200 hover:shadow-2xl transition-shadow duration-300">
              <div className="bg-[#FF6B35] w-20 h-20 rounded-2xl flex items-center justify-center mx-auto mb-6">
            ...
            {/* MGR */}
            <div className="bg-white rounded-2xl p-8 border border-gray-200 hover:shadow-2xl transition-shadow duration-300">
              <div className="bg-[#01BAEF] w-20 h-20 rounded-2xl flex items-center justify-center mx-auto mb-6">
      ...
      <section className="bg-[#FF6B35] py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 leading-tight">
            Begin Your Journey to Becoming an Endodontic Specialist
          </h2>
          ...
          <div className="flex flex-wrap justify-center gap-6">
            <button className="bg-white hover:bg-gray-100 text-[#FF6B35] font-bold px-10 py-4 rounded-lg text-lg transition-all duration-300 shadow-lg hover:shadow-xl">
              Download Prospectus
            </button>
