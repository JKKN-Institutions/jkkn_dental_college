          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-4 py-2 mb-6">
                ...
                <span className="text-[#FF6B35] font-semibold text-sm">DCI Approved | NAAC Accredited</span>
              </div>

              {/* Heading */}
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
                Master of Dental Surgery <span className="text-[#FF6B35]">(MDS)</span>
              </h1>

              {/* Description */}
              <p className="text-lg text-gray-200 mb-8 leading-relaxed">
                Elevate your dental career with specialized postgraduate training at J.K.K. Nattraja Dental College. Choose from 5 DCI-approved specializations and learn from expert Learning Facilitators using state-of-the-art facilities.
              </p>
              ...
              <div className="grid grid-cols-2 gap-4 mb-8">
                <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl p-6">
                  ...
                  <div className="text-sm text-gray-200 uppercase">Specializations</div>
                </div>
                <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl p-6">
                  <div className="text-4xl md:text-5xl font-bold text-[#FF6B35] mb-2">3</div>
                  <div className="text-sm text-gray-200 uppercase">Years Duration</div>
                </div>
                <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl p-6">
                  <div className="text-4xl md:text-5xl font-bold text-[#FF6B35] mb-2">23</div>
                  <div className="text-sm text-gray-200 uppercase">Total Seats</div>
                </div>
                <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl p-6">
                  <div className="text-4xl md:text-5xl font-bold text-[#FF6B35] mb-2">100%</div>
                  <div className="text-sm text-gray-200 uppercase">Clinical Training</div>
                </div>
              </div>
            </div>
            ...
            <div className="relative">
              <div className="relative rounded-2xl border-4 border-white/20 overflow-hidden bg-gradient-to-br from-[#0B4F6C] to-[#01BAEF] aspect-video flex items-center justify-center">
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex justify-center mb-6">
            <div className="inline-flex items-center gap-2 bg-[#FF6B35] rounded-full px-6 py-2">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            <div>
              <div className="bg-gradient-to-br from-[#0B4F6C] to-[#01BAEF] rounded-2xl p-12 h-full flex items-center justify-center">
            ...
            <div>
              ...
              <p className="text-gray-600 mb-8 leading-relaxed">
                At J.K.K. Nattraja Dental College, our MDS programs combine rigorous academic curriculum with extensive clinical exposure. Learners work on diverse cases under expert supervision, conduct original research, and develop the skills required to become leaders in their chosen specialization.
              </p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            ...
            <div className="bg-white border border-gray-200 rounded-2xl overflow-hidden hover:shadow-2xl transition-shadow duration-300">
              <div className="bg-gradient-to-br from-[#0B4F6C] to-[#01BAEF] p-8 relative">
                <div className="absolute top-4 left-4">
                  <span className="bg-[#FF6B35] text-white text-xs font-bold px-3 py-1 rounded-full uppercase">Specialization</span>
                </div>
                <div className="absolute top-4 right-4">
                  <span className="bg-white text-[#0B4F6C] text-xs font-bold px-3 py-1 rounded-full">4 Seats</span>
                </div>
                <h3 className="text-4xl font-bold text-white mt-12 text-center">Endodontics</h3>
              </div>
              <div className="p-6">
                <h4 className="text-xl font-bold text-[#0B4F6C] mb-2">MDS in Endodontics</h4>
                ...
                <a href="#" className="text-[#01BAEF] hover:text-[#0B4F6C] font-semibold flex items-center gap-2 transition-colors duration-300">
                  View Details
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="bg-white border border-gray-200 rounded-2xl overflow-hidden hover:shadow-2xl transition-shadow duration-300">
              <div className="bg-gradient-to-br from-[#0B4F6C] to-[#01BAEF] p-8 relative">
                ...
                <div className="absolute top-4 right-4">
                  <span className="bg-white text-[#0B4F6C] text-xs font-bold px-3 py-1 rounded-full">6 Seats</span>
                </div>
                <h3 className="text-4xl font-bold text-white mt-12 text-center">Prosthodontics</h3>
              </div>
              <div className="p-6">
                <h4 className="text-xl font-bold text-[#0B4F6C] mb-2">MDS in Prosthodontics</h4>
            ...
            <div className="bg-white border border-gray-200 rounded-2xl overflow-hidden hover:shadow-2xl transition-shadow duration-300">
              ...
              <div className="p-6">
                <h4 className="text-xl font-bold text-[#0B4F6C] mb-2">MDS in Periodontics</h4>
            ...
            <div className="bg-white border border-gray-200 rounded-2xl overflow-hidden hover:shadow-2xl transition-shadow duration-300">
              <div className="bg-gradient-to-br from-[#0B4F6C] to-[#01BAEF] p-8 relative">
                ...
                <div className="absolute top-4 right-4">
                  <span className="bg-white text-[#0B4F6C] text-xs font-bold px-3 py-1 rounded-full">3 Seats</span>
                </div>
                <h3 className="text-4xl font-bold text-white mt-12 text-center">Oral Medicine</h3>
              </div>
              <div className="p-6">
                <h4 className="text-xl font-bold text-[#0B4F6C] mb-2">MDS in Oral Medicine & Radiology</h4>
            ...
            <div className="bg-white border border-gray-200 rounded-2xl overflow-hidden hover:shadow-2xl transition-shadow duration-300">
              ...
              <div className="p-6">
                <h4 className="text-xl font-bold text-[#0B4F6C] mb-2">MDS in Orthodontics</h4>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex justify-center mb-6">
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-6 py-2">
              <span className="text-[#FF6B35] font-semibold text-sm uppercase">Why JKKN</span>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-6">
            ...
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-8 text-center hover:bg-white/20 transition-all duration-300">
              <div className="bg-[#FF6B35]/20 w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-6">
                <svg className="w-8 h-8 text-[#FF6B35]" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M13 6a3 3 0 11-6 0 3 3 0 016 0zM18 8a2 2 0 11-4 0 2 2 0 014 0zM14 15a4 4 0 00-8 0v3h8v-3zM6 8a2 2 0 11-4 0 2 2 0 014 0zM16 18v-3a5.972 5.972 0 00-.75-2.906A3.005 3.005 0 0119 15v3h-3zM4.75 12.094A5.973 5.973 0 004 15v3H1v-3a3 3 0 013.75-2.906z" />
                </svg>
              </div>
              <div className="text-4xl md:text-5xl font-bold text-[#FF6B35] mb-3">25+</div>
            ...
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-8 text-center hover:bg-white/20 transition-all duration-300">
              ...
              <div className="text-4xl md:text-5xl font-bold text-[#FF6B35] mb-3">150+</div>
            ...
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-8 text-center hover:bg-white/20 transition-all duration-300">
              ...
              <div className="text-4xl md:text-5xl font-bold text-[#FF6B35] mb-3">50K+</div>
            ...
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-8 text-center hover:bg-white/20 transition-all duration-300">
              ...
              <div className="text-4xl md:text-5xl font-bold text-[#FF6B35] mb-3">DCI</div>
            ...
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-8 text-center hover:bg-white/20 transition-all duration-300">
              ...
              <div className="text-4xl md:text-5xl font-bold text-[#FF6B35] mb-3">200+</div>
            ...
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-8 text-center hover:bg-white/20 transition-all duration-300">
              ...
              <div className="text-4xl md:text-5xl font-bold text-[#FF6B35] mb-3">Global</div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-gray-50 rounded-2xl p-8">
              <div className="flex items-center gap-3 mb-6 pb-6 border-b-4 border-[#FF6B35]">
            ...
            <div className="bg-gray-50 rounded-2xl p-8">
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  <div className="bg-[#0B4F6C] text-white w-12 h-12 rounded-full flex items-center justify-center font-bold flex-shrink-0 text-lg">
                    1
                  </div>
                  <div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4">
            ...
            <details className="group border-2 border-gray-200 rounded-xl overflow-hidden bg-white">
              <summary className="flex items-center justify-between cursor-pointer p-6 font-bold text-[#0B4F6C] text-lg hover:bg-gray-50 transition-colors duration-300">
                What is MDS (Master of Dental Surgery)?
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-5xl mx-auto">
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-8 hover:shadow-xl transition-shadow duration-300">
              <div className="bg-[#0B4F6C] rounded-lg p-6 mb-4 flex items-center justify-center h-32">
      ...
      <section className="bg-[#FF6B35] py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-6">
            <Link href="https://admission.jkkn.ac.in/form/jkkn-institution-admission-yxs3w8" className="bg-white hover:bg-gray-100 text-[#FF6B35] font-bold px-10 py-4 rounded-lg text-lg transition-all duration-300 shadow-lg hover:shadow-xl flex items-center gap-2 inline-flex">
              Apply Now
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clipRule="evenodd" />
              </svg>
            </Link>
            <a href="#" className="bg-transparent border-2 border-white text-white hover:bg-white hover:text-[#FF6B35] font-bold px-10 py-4 rounded-lg text-lg transition-all duration-300 flex items-center gap-2 inline-block">
              Download Brochure
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
