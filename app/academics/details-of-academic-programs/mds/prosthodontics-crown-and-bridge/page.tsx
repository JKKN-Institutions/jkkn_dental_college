  ...
  return (
    <main>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
                MDS Prosthodontics & <span className="text-[#FF6B35]">Crown and Bridge</span>
              </h1>
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-[#0B4F6C] to-[#0a3f54] rounded-2xl p-12 border-4 border-white/20 overflow-hidden">
                ...
                <div className="grid grid-cols-3 gap-4">
                  ...
                  <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl p-6 text-center">
                    <div className="text-4xl md:text-5xl font-bold text-[#FF6B35] mb-2">6</div>
      ...
      <section className="bg-gray-50 py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-4">
            <span className="text-[#FF6B35] font-bold text-sm uppercase tracking-wider">PROGRAM OVERVIEW</span>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-[#FF6B35] to-[#e55a2b] rounded-2xl p-12 h-full flex items-center justify-center min-h-[500px]">
                <h2 className="text-5xl md:text-6xl font-bold text-white text-center">Clinical Training</h2>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="bg-white py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-4">
            <span className="text-[#FF6B35] font-bold text-sm uppercase tracking-wider">COURSE STRUCTURE</span>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl overflow-hidden shadow-lg border border-gray-200">
              <div className="bg-gradient-to-br from-[#0B4F6C] to-[#0a3f54] p-8 text-center">
            ...
            <div className="bg-white rounded-2xl overflow-hidden shadow-lg border border-gray-200">
              <div className="bg-gradient-to-br from-[#FF6B35] to-[#e55a2b] p-8 text-center">
                <div className="inline-block bg-white/20 backdrop-blur-sm rounded-full px-4 py-1 mb-4">
            ...
            <div className="bg-white rounded-2xl overflow-hidden shadow-lg border border-gray-200">
              <div className="bg-gradient-to-br from-[#01BAEF] to-[#0099cc] p-8 text-center">
                <div className="inline-block bg-white/20 backdrop-blur-sm rounded-full px-4 py-1 mb-4">
      ...
      <section className="bg-gray-50 py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-4">
            <span className="text-[#FF6B35] font-bold text-sm uppercase tracking-wider">WHAT YOU&apos;LL ACHIEVE</span>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-200">
              <div className="bg-gray-100 rounded-xl p-6 mb-6 flex items-center justify-center">
                <svg className="w-16 h-16 text-[#FF6B35]" fill="currentColor" viewBox="0 0 20 20">
      ...
      <section className="bg-white py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-4">
            <span className="text-[#FF6B35] font-bold text-sm uppercase tracking-wider">WHO CAN APPLY</span>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-gray-50 rounded-2xl p-8 border border-gray-200">
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  <div className="bg-[#FF6B35] rounded-full w-10 h-10 flex items-center justify-center flex-shrink-0">
            ...
            <div className="bg-gray-50 rounded-2xl p-8 border border-gray-200">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="flex items-center gap-3">
                  <div className="bg-[#01BAEF] rounded-full p-2 flex-shrink-0">
      ...
      <section className="bg-gray-50 py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-4">
            <span className="text-[#FF6B35] font-bold text-sm uppercase tracking-wider">WORLD-CLASS INFRASTRUCTURE</span>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {/* CAD/CAM Center */}
            <div className="bg-white rounded-2xl overflow-hidden shadow-lg border border-gray-200">
              <div className="bg-gradient-to-br from-[#0B4F6C] to-[#0a3f54] p-12 flex items-center justify-center h-48">
            ...
            {/* Implant Suite */}
            <div className="bg-white rounded-2xl overflow-hidden shadow-lg border border-gray-200">
              <div className="bg-gradient-to-br from-[#FF6B35] to-[#e55a2b] p-12 flex items-center justify-center h-48">
            ...
            {/* Ceramic Lab */}
            <div className="bg-white rounded-2xl overflow-hidden shadow-lg border border-gray-200">
              <div className="bg-gradient-to-br from-[#01BAEF] to-[#0099cc] p-12 flex items-center justify-center h-48">
      ...
      <section className="bg-white py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-4">
            <span className="text-[#FF6B35] font-bold text-sm uppercase tracking-wider">CAMPUS LIFE</span>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {/* Campus */}
            <div className="bg-gradient-to-br from-[#0B4F6C] to-[#0a3f54] rounded-xl p-12 flex items-center justify-center h-48 cursor-pointer hover:scale-105 transition-transform duration-300">
              <h3 className="text-3xl font-bold text-white text-center">Campus</h3>
            </div>

            {/* Clinic */}
            <div className="bg-gradient-to-br from-[#FF6B35] to-[#e55a2b] rounded-xl p-12 flex items-center justify-center h-48 cursor-pointer hover:scale-105 transition-transform duration-300">
              <h3 className="text-3xl font-bold text-white text-center">Clinic</h3>
            </div>

            {/* Library */}
            <div className="bg-gradient-to-br from-[#01BAEF] to-[#0099cc] rounded-xl p-12 flex items-center justify-center h-48 cursor-pointer hover:scale-105 transition-transform duration-300">
              <h3 className="text-3xl font-bold text-white text-center">Library</h3>
            </div>

            {/* Conference */}
            <div className="bg-gradient-to-br from-[#0B4F6C] to-[#0a3f54] rounded-xl p-12 flex items-center justify-center h-48 cursor-pointer hover:scale-105 transition-transform duration-300">
              <h3 className="text-3xl font-bold text-white text-center">Conference</h3>
            </div>

            {/* Hostel */}
            <div className="bg-gradient-to-br from-[#FF6B35] to-[#e55a2b] rounded-xl p-12 flex items-center justify-center h-48 cursor-pointer hover:scale-105 transition-transform duration-300">
              <h3 className="text-3xl font-bold text-white text-center">Hostel</h3>
            </div>

            {/* Sports */}
            <div className="bg-gradient-to-br from-[#01BAEF] to-[#0099cc] rounded-xl p-12 flex items-center justify-center h-48 cursor-pointer hover:scale-105 transition-transform duration-300">
              <h3 className="text-3xl font-bold text-white text-center">Sports</h3>
            </div>

            {/* Lab */}
            <div className="bg-gradient-to-br from-[#0B4F6C] to-[#0a3f54] rounded-xl p-12 flex items-center justify-center h-48 cursor-pointer hover:scale-105 transition-transform duration-300">
              <h3 className="text-3xl font-bold text-white text-center">Lab</h3>
            </div>

            {/* Cafeteria */}
            <div className="bg-gradient-to-br from-[#FF6B35] to-[#e55a2b] rounded-xl p-12 flex items-center justify-center h-48 cursor-pointer hover:scale-105 transition-transform duration-300">
              <h3 className="text-3xl font-bold text-white text-center">Cafeteria</h3>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-gradient-to-br from-[#0B4F6C] to-[#0a3f54] py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-4">
            <span className="text-[#FF6B35] font-bold text-sm uppercase tracking-wider">YOUR FUTURE</span>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-8">
              <div className="bg-[#FF6B35] rounded-lg p-4 w-16 h-16 flex items-center justify-center mb-6">
                <svg className="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 20 20">
      ...
      <section className="bg-white py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-4">
            <span className="text-[#FF6B35] font-bold text-sm uppercase tracking-wider">INVESTMENT IN YOUR FUTURE</span>
          </div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full bg-white rounded-2xl overflow-hidden shadow-lg">
              <thead>
                <tr className="bg-gradient-to-br from-[#0B4F6C] to-[#0a3f54]">
                  <th className="px-6 py-4 text-left text-white font-bold text-lg">FEE COMPONENT</th>
                  <th className="px-6 py-4 text-left text-white font-bold text-lg">YEAR 1</th>
                  <th className="px-6 py-4 text-left text-white font-bold text-lg">YEAR 2</th>
                  <th className="px-6 py-4 text-left text-white font-bold text-lg">YEAR 3</th>
                </tr>
              </thead>
              <tbody>
                <tr className="border-b border-gray-200">
                  <td className="px-6 py-4 text-gray-700">Tuition Fee</td>
                  <td className="px-6 py-4 text-gray-900 font-semibold">₹ 8,00,000</td>
                  <td className="px-6 py-4 text-gray-900 font-semibold">₹ 8,00,000</td>
                  <td className="px-6 py-4 text-gray-900 font-semibold">₹ 8,00,000</td>
                </tr>
                <tr className="border-b border-gray-200">
                  <td className="px-6 py-4 text-gray-700">Laboratory Fee</td>
                  <td className="px-6 py-4 text-gray-900 font-semibold">₹ 50,000</td>
                  <td className="px-6 py-4 text-gray-900 font-semibold">₹ 50,000</td>
                  <td className="px-6 py-4 text-gray-900 font-semibold">₹ 50,000</td>
                </tr>
                <tr className="border-b border-gray-200">
                ...
                <tr className="border-b border-gray-200">
                  <td className="px-6 py-4 text-gray-700">Examination Fee</td>
                ...
                <tr className="bg-gray-50">
                  ...
                  <td className="px-6 py-4 text-gray-900 font-bold">₹ 8,90,000</td>
                  <td className="px-6 py-4 text-gray-900 font-bold">₹ 8,90,000</td>
                  <td className="px-6 py-4 text-gray-900 font-bold">₹ 8,90,000</td>
                </tr>
              </tbody>
          ...
          {/* Info Note */}
          <div className="mt-8 bg-blue-50 border-l-4 border-[#01BAEF] p-6 rounded-r-lg">
            <div className="flex gap-3">
              <svg className="w-6 h-6 text-[#01BAEF] flex-shrink-0 mt-1" fill="currentColor" viewBox="0 0 20 20">
      ...
      <section className="bg-gray-50 py-20 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-4">
            <span className="text-[#FF6B35] font-bold text-sm uppercase tracking-wider">GOT QUESTIONS?</span>
          </div>
          ...
          <div className="space-y-4">
            ...
            <details className="bg-white rounded-xl p-6 shadow-md group">
              <summary className="flex justify-between items-center cursor-pointer list-none">
                ...
                <svg className="w-6 h-6 text-[#FF6B35] transform group-open:rotate-180 transition-transform" fill="currentColor" viewBox="0 0 20 20">
      ...
      <section className="bg-white py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-4">
            <span className="text-[#FF6B35] font-bold text-sm uppercase tracking-wider">RECOGNITION</span>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-200 text-center">
              <div className="bg-gradient-to-br from-[#0B4F6C] to-[#0a3f54] rounded-xl p-6 mb-6 flex items-center justify-center mx-auto w-24 h-24">
            ...
            {/* NAAC */}
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-200 text-center">
              <div className="bg-gradient-to-br from-[#FF6B35] to-[#e55a2b] rounded-xl p-6 mb-6 flex items-center justify-center mx-auto w-24 h-24">
            ...
            {/* MGR */}
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-200 text-center">
              <div className="bg-gradient-to-br from-[#01BAEF] to-[#0099cc] rounded-xl p-6 mb-6 flex items-center justify-center mx-auto w-24 h-24">
      ...
      {/* Final CTA Section */}
      <section className="bg-gradient-to-br from-[#FF6B35] to-[#e55a2b] py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <button className="bg-white text-[#FF6B35] hover:bg-gray-100 font-bold px-8 py-4 rounded-lg text-lg transition-all duration-300 shadow-lg">
              Download Prospectus
            </button>
            <button className="bg-transparent border-2 border-white text-white hover:bg-white hover:text-[#FF6B35] font-bold px-8 py-4 rounded-lg text-lg transition-all duration-300">
              Apply Online
            </button>
          </div>
        </div>
